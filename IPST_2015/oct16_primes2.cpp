...
void listP(int d){
    if(d>=5){
        ...
        if(d==4){
            s[1][d] = n-(s[1][3]+s[1][2]+s[1][1]+s[1][0]);
            s[2][d] = n-(s[2][3]+s[2][2]+s[2][1]+s[2][0]);
            s[3][d] = n-(s[3][3]+s[3][2]+s[3][1]+s[3][0]);
            s[4][d] = n-(s[4][3]+s[4][2]+s[4][1]+s[4][0]);
            if(s[1][4]>=0&&s[2][4]>=0&&s[3][4]>=0&&s[4][4]>=0
               &&s[1][4]<=9&&s[2][4]<=9&&s[3][4]<=9&&s[4][4]<=9
               &&s[1][4]%2&&s[2][4]%2&&s[3][4]%2&&s[4][4]%2){
                listP(5);
            }
        }else{
            for(int i = 0; i < ptr; i++){
