...
#pragma config(Motor,  port1,           rwheel,        tmotorVex393_HBridge, openLoop, encoderPort, I2C_5)
#pragma config(Motor,  port2,           mcone,         tmotorVex393_MC29, openLoop, reversed)
...
#pragma config(Motor,  port8,           rgrabber,      tmotorVex393_MC29, openLoop, reversed)
#pragma config(Motor,  port9,           lgrabber,      tmotorVex393_MC29, openLoop, encoderPort, I2C_1)
...
task main()
{
	...
	while(1){
		...
		if(vexRT[Btn6U]){
			...
			//motor[slift_tl] = 0;
			//motor[slift_br] = 0;
			motor[slift_tb] = liftRestPow;
			motor[slift_tl] = liftRestPow;
			motor[slift_br] = liftRestPow;
		}
