...
#define MOTOR_DEFAULT_SLEW_RATE 20      // Default will cause 375mS from full fwd to rev
...
task usercontrol()
{
  ...
  while (true)
  {
    ...
    // values based on feedback from the joysticks.
  	...
  	// Tank Drive
  	motorReq[lwheels] = vexRT[Ch3];
  	//motorReq[lblift] = vexRT[Ch3];
		//motorReq[ltlift] = vexRT[Ch3];

  	motorReq[rwheels] = vexRT[Ch2];
